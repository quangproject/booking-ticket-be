...
class BookingController {
    async index(req, res) {
        try {
            ...
            console.log("🚀 ~ BookingController ~ index ~ error:", error)
    ...
    async create(req, res) {
        try {
            ...
            console.log("🚀 ~ BookingController ~ create ~ error:", error)
            return res.status(500).json({
                error: "Internal Server Error"
            })
        }
    ...
    async searchByEmail(req, res) {
        try {
            ...
            console.log("🚀 ~ BookingController ~ searchByEmail ~ error:", error)
            return res.status(500).json({
                error: "Internal Server Error"
            })
        }
    ...
    async deleteBooking(req, res) {
        try {
            ...
            console.log("🚀 ~ BookingController ~ deleteBooking ~ error:", error)
            return res.status(500).json({
                error: "Internal Server Error"
            })
        }
    ...
    async truncate(req, res) {
        try {
            ...
            console.log("🚀 ~ BookingController ~ truncate ~ error:", error)
            return res.status(500).json({
                error: "Internal Server Error"
            })
        }
